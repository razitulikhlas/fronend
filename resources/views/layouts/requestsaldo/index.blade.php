        ...
        <div class="modal-body">
           <form id="formEdit" action="" method="post" >
            ...
            <div class="form-group">
              ...
              <br>
              <img src="{{ env('BASE_URL_IMAGE'). $item["image"] }}" class="img-thumbnail" alt="...">
            </div>
          <button type="button"  class="btn btn-secondary" data-dismiss="modal">Close</button>
          <button type="submit" id="btnProses" class="btn btn-primary">Ubah Data</button>
          <a id="btnCancel" href="" class="btn btn-danger btn-sm" >Cancel</a>
